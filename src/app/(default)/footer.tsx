      ...
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="justify-between sm:flex">
          <div className="space-y-6">
            ...
            <p className="max-w-md">Nulla auctor metus vitae lectus iaculis, vel euismod massa efficitur.</p>
            ...
            <div className="flex items-center gap-3 mt-3 sm:block">
              <a href="/replace-link">
                <svg className="w-32" fill="none" viewBox="0 0 338 100">
                  ...
                  <path fill="#000" d="M83.052 51.289a3.08 3.08 0 00.288-1.283v-.002c0 .432-.096.864-.288 1.285z" />
                  <path
              ...
              <a href="/replace-link" className="mt-0 block sm:mt-3">
